...
if page == "About the project":
    ...
    st.subheader("This app predicts housing prices in Stockholm using machine learning")

    col1, col2 = st.columns(2, gap="large")
    with col1:
        st.markdown("""
        #### 🧪 Test Models
        Enter your own property data and get predicted prices from both models.
        ⚠️ Note: THESE PREDICTIONS ARE GENERATED BY **DUMMY MODELS TRAINED ON SYNTHETIC DATA** for demonstration purposes.
        **No real data from the housing company was used for training these models.**
        
        #### 📊 Analyse Models
        EXPLORE THE PERFORMANCE OF THE **ACTUAL TRAINED MODELS** using real historical housing data:
    ...
    with col2: 
        ...
        #### Purpose
        Compare models and explore housing price patterns in Stockholm based on real data.

        #### ⚠️ Note
        Analysis is based on historical data and is for educational purposes only. **USER ENTERED PREDICTIONS REMAIN SYNTHETIC.**
        """)
